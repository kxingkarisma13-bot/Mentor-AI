-- Fix search_path for sensitive data detection functions

-- Update prevent_sensitive_data_in_messages function
...
-- Update prevent_sensitive_data_in_notes function
...
-- Update detect_sensitive_data function
