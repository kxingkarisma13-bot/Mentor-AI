...
DROP POLICY IF EXISTS "Prevent bulk savings goals access" ON public.savings_goals;
DROP POLICY IF EXISTS "Prevent bulk transaction access" ON public.financial_transactions;

-- Drop existing triggers if they exist
DROP TRIGGER IF EXISTS audit_financial_transaction_trigger ON public.financial_transactions;
DROP TRIGGER IF EXISTS audit_consultation_payment_trigger ON public.consultations;
DROP TRIGGER IF EXISTS audit_profile_changes_trigger ON public.user_profiles;
DROP TRIGGER IF EXISTS prevent_sensitive_data_messages_trigger ON public.consultation_messages;
DROP TRIGGER IF EXISTS prevent_sensitive_data_consultation_notes_trigger ON public.consultations;
DROP TRIGGER IF EXISTS prevent_sensitive_data_purchase_notes_trigger ON public.big_purchase_plans;
DROP TRIGGER IF EXISTS prevent_sensitive_data_mood_notes_trigger ON public.mood_entries;
